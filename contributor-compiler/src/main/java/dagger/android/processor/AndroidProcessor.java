...
public final class AndroidProcessor extends BasicAnnotationProcessor {
    ...
    protected Iterable<? extends ProcessingStep> initSteps() {
        ...
        return ImmutableList.of(
                ...
                new dagger.android.processor.ContributesAndroidInjectorGenerator(
                        new dagger.android.processor.AndroidInjectorDescriptor.Validator(types, elements, messager),
                        useStringKeys(),
                        filer,
                        elements,
